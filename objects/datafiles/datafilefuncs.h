...
extern GtkWidget *obj_create_datafilewin (void);  
extern void loaduserdatafiles (GtkCTreeNode *, char *, const char *, const char *);  
extern void get_datafile_info (const char *, const char *, const char *, const char *, DirNode *);
extern void obj_create_datafile_toolbar (void);  
extern void show_generic_datafile_window(const char *, const char *, const char *);
extern void obj_dodatafileview(GtkWidget *, GtkWidget *);

extern GtkWidget *alter_datafilewin (char *,char *,char *,char *,char *);

extern GtkWidget* create_datafilewin (void);
