...
void
on_ndx_script_activate(
    GtkMenuItem     *menuitem,
    gpointer         user_data)
{
    DirNode *dir = (DirNode *)user_data;
    fprintf(stderr, "Generate SQL script for index %s\n", dir->path);
}
*/
