...
build_seq_sql(void)
{
    ...
    if(seqsql.alterflag==0)
        g_string_append(query, "CREATE SEQUENCE ");
    else
        g_string_append(query, "ALTER SEQUENCE ");
    ...
    if(obj_ginfo.highlighting)
        gtk_editor_hilite_buffer (GTK_EDITOR(seqwin_text1));
...
static void
on_seqseqwin_radiobutton1_toggled(
...
static void
on_seqseqwin_radiobutton2_toggled(
    GtkToggleButton *togglebutton,
    gpointer         user_data)
{
    if (GTK_TOGGLE_BUTTON (togglebutton)->active==1)
...
static void
on_seqseqwin_radiobutton4_toggled(
    GtkToggleButton *togglebutton,
    gpointer         user_data)
{
    if (GTK_TOGGLE_BUTTON (togglebutton)->active==1)
...
static void
on_seqseqwin_radiobutton5_toggled(
    GtkToggleButton *togglebutton,
    gpointer         user_data)
{
    if (GTK_TOGGLE_BUTTON (togglebutton)->active==1)
...
static void
on_seqseqwin_checkbutton1_toggled(
    GtkToggleButton *togglebutton,
    gpointer         user_data)
{
    if (GTK_TOGGLE_BUTTON (togglebutton)->active==1)
...
static void
on_seqseqwin_checkbutton2_toggled(
    GtkToggleButton *togglebutton,
    gpointer         user_data)
{
    if (GTK_TOGGLE_BUTTON (togglebutton)->active==1)
    ...
    gpointer   user_data)
{
	...
	if(seqsql.alterflag==0){
	    msgbox("Sequence has been created");
	}else
	    msgbox("Sequence has been altered");
    }
    gtk_widget_destroy(seqwin_window1);
    g_free(cp);
}


static void
on_seqbutton2_clicked(
    GtkButton       *button,
    gpointer         user_data)
{
    gtk_widget_destroy(seqwin_window1);
...
create_seqwin_window1 ()
{
    ...
    seqwin_window1 = gtk_window_new (GTK_WINDOW_TOPLEVEL);
    gtk_object_set_data (GTK_OBJECT (seqwin_window1), "seqwin_window1", seqwin_window1);
    gtk_window_set_title (GTK_WINDOW (seqwin_window1), ("Create Sequence"));
    gtk_window_set_position (GTK_WINDOW (seqwin_window1), GTK_WIN_POS_CENTER);

    vbox1 = gtk_vbox_new (FALSE, 0);
    gtk_widget_ref (vbox1);
    gtk_widget_set_usize (vbox1, 403, 398);
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "vbox1", vbox1,
			      (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (vbox1);
    gtk_container_add (GTK_CONTAINER (seqwin_window1), vbox1);

    fixed3 = gtk_fixed_new ();
    gtk_widget_ref (fixed3);
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed3", fixed3,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_fixed_put (GTK_FIXED (fixed3), pixmap1, 300, 8);

    seqwin_entry1 = gtk_entry_new ();
    gtk_widget_ref (seqwin_entry1);
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_entry1", seqwin_entry1,
			      (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (seqwin_entry1);
    gtk_fixed_put (GTK_FIXED (fixed3), seqwin_entry1, 100, 8);
    gtk_widget_set_uposition (seqwin_entry1, 100, 8);
    gtk_widget_set_usize (seqwin_entry1, 158, 22);

    label1 = gtk_label_new (("Name:"));
    gtk_widget_ref (label1);
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label1", label1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_combo1", seqwin_combo1,
			      (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (seqwin_combo1);
    gtk_fixed_put (GTK_FIXED (fixed3), seqwin_combo1, 100, 32);
    gtk_widget_set_uposition (seqwin_combo1, 100, 32);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_combo_entry1", seqwin_combo_entry1,
			      (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (seqwin_combo_entry1);

    label2 = gtk_label_new (("Owner:"));
    gtk_widget_ref (label2);
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label2", label2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_radiobutton1", seqwin_radiobutton1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_radiobutton2", seqwin_radiobutton2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed2", fixed2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "frame1", frame1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed4", fixed4,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_entry3", seqwin_entry3,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_entry4", seqwin_entry4,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_entry5", seqwin_entry5,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_entry6", seqwin_entry6,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label3", label3,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label4", label4,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label5", label5,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "label6", label6,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed1", fixed1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "frame2", frame2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed5", fixed5,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "frame3", frame3,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "fixed6", fixed6,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_radiobutton4", seqwin_radiobutton4,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_radiobutton5", seqwin_radiobutton5,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_checkbutton1", seqwin_checkbutton1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "seqwin_checkbutton2", seqwin_checkbutton2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "hbuttonbox1", hbuttonbox1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "button1", button1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (seqwin_window1), "button2", button2,
			      (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (button2);
    gtk_container_add (GTK_CONTAINER (hbuttonbox1), button2);
    GTK_WIDGET_SET_FLAGS (button2, GTK_CAN_DEFAULT);

    seqwin_text1 = add_sql_window(vbox1);

    gtk_signal_connect (GTK_OBJECT (seqwin_entry1), "changed",
			GTK_SIGNAL_FUNC (on_seqentry1_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_combo_entry1), "changed",
			GTK_SIGNAL_FUNC (on_seqcombo_entry1_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_radiobutton1), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_radiobutton1_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_radiobutton2), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_radiobutton2_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_entry3), "changed",
			GTK_SIGNAL_FUNC (on_seqseqwin_entry3_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_entry4), "changed",
			GTK_SIGNAL_FUNC (on_seqseqwin_entry4_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_entry5), "changed",
			GTK_SIGNAL_FUNC (on_seqseqwin_entry5_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_entry6), "changed",
			GTK_SIGNAL_FUNC (on_seqseqwin_entry6_changed),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_radiobutton4), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_radiobutton4_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_radiobutton5), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_radiobutton5_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_checkbutton1), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_checkbutton1_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (seqwin_checkbutton2), "toggled",
			GTK_SIGNAL_FUNC (on_seqseqwin_checkbutton2_toggled),
			NULL);
    gtk_signal_connect (GTK_OBJECT (button1), "clicked",
			GTK_SIGNAL_FUNC (on_seqbutton1_clicked),
			NULL);
    gtk_signal_connect (GTK_OBJECT (button2), "clicked",
			GTK_SIGNAL_FUNC (on_seqbutton2_clicked),
			NULL);
    ...
    generic_populate_schemas(seqwin_combo1,seqwin_combo_entry1, obj_cinfo.login->dbid);  

    return seqwin_window1;
}
